  ...
  return (
    <section className="bg-white ">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <h2 className="mb-4 text-xl sm:text-4xl tracking-tight font-extrabold sm:text-center text-gray-900 ">Contact
                        Us</h2>
                    <p className="mb-8 lg:mb-16 font-light sm:text-center text-gray-500  sm:text-xl">Got
